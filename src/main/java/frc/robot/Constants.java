...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static  double kMaxAngularSpeed = 1.5 * Math.PI; // radians per second
  ...
  public static final class ModuleConstants {
    ...
    public static final double kTurningI = 0.00000001;
    public static final double kTurningD = 0.00005;
    public static final double kTurningFF = 0.001;
